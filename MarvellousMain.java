...
class MarvellousLogin extends Template implements ActionListener,Runnable
{
    ...
    MarvellousLogin()
    {
        _content = new JPanel();  // Initialize _content
        _content.setLayout(null);  // or any other layout manager
        this.add(_content, BorderLayout.CENTER);

        _header = new JPanel();
        _header.setLayout(null);  // or any other layout manager
        ...
        text1.setBounds(200,135,size.width,tsize.height);
        ...
        exit = new JButton("EXIT");  // Exit button added
        exit.setBounds(200, 220, ssize.width, ssize.height); 
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if( ae.getSource() == SUBMIT)
        {
            if(Validate(value1,value2) == false )
            {
                text1.setText("");
                text2.setText("");
                JOptionPane.showMessageDialog(this,"Short username","Marevllous packer Unpacker ",JOptionPane.ERROR_MESSAGE);
            } 
            if(value1.equals("MarevllousAdmin")&& value2.equals("MarevllousAdmin"))
            {
            ...
            else 
            {
                ...
                if(attemp == 0 )
                {
                    JOptionPane.showMessageDialog(this,"Number of attempts finished","Marevllous Packer Unpacker",JOptionPane.ERROR_MESSAGE);
                        this.dispose();
                    System.exit(0);
                }
